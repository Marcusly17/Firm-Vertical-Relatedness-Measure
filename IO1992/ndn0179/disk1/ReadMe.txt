...
transportation costs and margins)

NOTE: The data presented here conform to SIC
...
Ordering Information
      ...
      Accession number    NDN-0179
      Price               $40  (2 diskettes)
...
the uncompressed files is:
            ...
            SICMake.txt     -- 4.6 megabytes
            SICUse.txt      -- 9.6 megabytes
...
SICMake.exe     1     Compressed IOMake.txt. The Make of
                      Commodities by Industries
SICUse.exe      2     Compressed IOUse.txt. The Use of
                      Commodities by Industries
SICMake.fmt     1     File layout table for IOMake.txt
SICUse.fmt      2     File layout table for IOUse.txt
