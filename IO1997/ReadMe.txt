...
Detailed Make Table and Use Table before Redefinitions 
...
Description of data
  ...
  represent millions of dollars at producers' prices. All cells 
...
Description of files
  ...
  Table 1.              --  The Make of Commodities by Industries before 
                            Redefinitions, 1997 Benchmark 
                            (uncompressed file NAICSMakeDetail.txt)

  FNAICSMakeDetail.txt  --  File layout table for NAICSMakeDetail.txt

  Table 2.              --  The Use of Commodities by Industries before 
                            Redefinitions, 1997 Benchmark
                            (uncompressed file NAICSUseDetail.txt)
     
  FNAICSUseDetail.txt   --  File layout table for NAICSUseDetail.txt
